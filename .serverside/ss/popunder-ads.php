...
$UID     =  "293635"; // Your publisherID
$WID     =  "666154"; // Your domainID
$TOKEN   =  "f5d8799e8c094e2f8c74-1618421722-a87533ba26de85c78d48293635"; // Token used in PopCash API
$OPTIONS = [
  "pop_fback" => "up", // values: 'under' or 'up'
...
class PopcashPublisherScript
{
  ...
  public function getCode()
  {
    ...
    curl_setopt_array($curl, [
      ...
      CURLOPT_REFERER        => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "nhentai.my.id",
    ]);
